...
.search-form { display: grid; grid-template-columns: minmax(0,1fr) 74px; gap: 10px; }.search-form label { min-width: 0; min-height: 48px; display: flex; align-items: center; gap: 10px; padding: 0 14px; border: 1px solid #bfcce0; border-radius: 11px; background: #fff; color: #7f8ba0; }.search-form label:focus-within { border-color: var(--app-primary); }.search-form label>.anticon { flex: 0 0 auto; font-size: 21px; }.search-form input { min-width: 0; width: 100%; height: 44px; padding: 0; border: 0; outline: 0; background: transparent; color: var(--search-ink); font-size: 13px; }.search-form input::placeholder { color: #8996aa; }.search-form>button { min-height: 48px; padding: 0 12px; border: 0; border-radius: 11px; background: linear-gradient(135deg,#2174f8,#1760ee); box-shadow: 0 7px 14px rgba(23,105,246,.16); color: #fff; font-size: 14px; font-weight: 700; }.search-form>button:disabled { opacity: .65; }
